...
export default function MyGroups(){
    ...
    return(
        <div className="flex min-h-screen gap-8">
            ...
            <input className="max-sm:w-full" type="text" name= "search" value= {myGroups.search} onChange= { (e) => { setMyGroups( {...myGroups, search: e.target.value, page:1})}} placeholder="Search by group name"/><br/>
